          ...
          <div class="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
            <div class="w-full px-4 lg:w-1/4 md:w-1/2">
              <nav class="mb-10 list-none">
                <li class="mt-3">
                  <h2 class="mb-3 text-sm font-medium tracking-widest text-gray-100 uppercase title-font">
                    Horarios Atención
                  </h2>
                  <p class="text-gray-300 cursor-pointer">Lunes a Viernes.</p>
                  <p class="text-gray-300 cursor-pointer">
              ...
              <nav class="mb-10 list-none">
                <li class="mt-3">
                  ...
                  <a
                    ...
                    className="pt-2"
                  >
                    <p class="text-blue-200 underline cursor-pointer">
            ...
            <div class="w-full pl-14 lg:w-1/4 md:w-1/2">
              <nav class="mb-10 list-none">
                <li class="mt-3">
                  ...
                  <li className="mb-2">
                    <p class="text-gray-100 cursor-pointer flex uppercase text-sm title-font">
                      Ventas
                    </p>
                    <p class="text-gray-300 cursor-pointer flex pl-3 pt-1">
                      <Icon whatsapp className={"text-xl pr-1 pt-0.5"} /> +54
                      353 4175020
                    </p>
                  </li>
                  <li>
