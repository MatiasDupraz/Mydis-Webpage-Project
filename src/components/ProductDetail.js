...
<div className="mb-6">
<h2 className="mb-2 text-lg font-bold text-gray-700 dark:text-gray-400">Descripción</h2>
...
<span className="text-base text-gray-600 dark:text-gray-400">En Stock</span>
<p className="text-base text-gray-600 dark:text-gray-400">Cantidad disponible: {stock}</p>
</div>
