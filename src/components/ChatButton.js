...
const ChatButton = () => {
  ...
  const toggleChatbox = () => {
    ...
    const finalformWraperClassName = classNames(`formbold-form-wrapper mx-auto ${
      isChatboxVisible ? '' : 'hidden'
    } w-full max-w-[550px] rounded-lg shadow-lg bg-white`)
  ...
  return (
    ...
    <div class="relative">
      ...
      >
        ...
        >
          <h3 class="text-lg font-bold text-white">Comunicate con nosotros</h3>
        ...
        >
          ...
          <div>
            <button onClick={handleSubmit}
              class="hover:shadow-form w-full rounded-md bg-neutral-900 py-3 px-8 text-center text-base font-semibold text-white outline-none"
            >
              Iniciar Chat
            </button>
          </div>
